...
public class DeleteProductCommandHandlerTests
{
    ...
    public async Task Handle_WhenReferencedAsUnpackTarget_ReturnsFailure()
    {
        ...
        _productRepository.Setup(r => r.IsReferencedAsUnpackTargetAsync(product.Id, TenantId, It.IsAny<CancellationToken>()))
            .ReturnsAsync(true);
    ...
    public async Task Handle_WhenValid_RemovesProductAndComponentsAndReturnsSuccess()
    {
        ...
        _componentRepository.Verify(r => r.RemoveAllByParentIdAsync(product.Id, TenantId, It.IsAny<CancellationToken>()),
            Times.Once);
